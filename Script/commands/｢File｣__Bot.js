...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "Rohit") || (event.body.toLowerCase() == "Ullash vai") || (event.body.toLowerCase() == "@Arata Kaizaki") || (event.body.toLowerCase() == "রহিত")) {
